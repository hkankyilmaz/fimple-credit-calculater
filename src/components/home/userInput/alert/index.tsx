...
export const AlertMessage = React.forwardRef<any, any>(
  ({ errors }, alertRef) => {
    ...
    const handleClose = ( event?: React.SyntheticEvent | Event,reason?: string ) => {
      ...
      setState({ open: false, Transition: Fade,});
      ...
      <Stack spacing={2}>
        ...
        >
          {Object.keys(errors).length === 0 ? (
            <Alert sx={{ backgroundColor: "rgba(9, 211, 172,1)",  width: "100%", }}  severity="success" >
            ...
            <Alert sx={{backgroundColor: "#ff9999",width: "100%",}} severity="error">
              <AlertTitle sx={{ fontWeight: "bold" }}>
